...
public class ResultService {
    ...
    public static void saveResult(double n1, double n2, double sum, double product,  double substraction, double division) {
        ...
        try (Connection conn = DriverManager.getConnection(dbUrl, DB_USER, DB_PASSWORD);
            ...
            String createTable = """
                CREATE TABLE IF NOT EXISTS calc_results (
                    ...
                    substraction_result DOUBLE NOT NULL,
            ...
            // Insert the result
            String insert = "INSERT INTO calc_results (number1, number2, sum_result, product_result, substraction_result, division_result) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            System.out.println("✅ Result saved: " + n1 + ", " + n2 + " → Sum=" + sum + ", Product=" + product + ", Substraction=" + substraction + ", Division=" + division);
